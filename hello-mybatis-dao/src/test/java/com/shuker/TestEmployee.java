...
import com.shuker.dao.impl.EmployeedaoImpl;
...
public class TestEmployee {
    ...
    public  void testInsertDao() throws IOException {
        EmployeeDao ado = new EmployeedaoImpl();
        int hzougeijng = ado.insertEmloyee(new Employee(null, "hzougeijng", '0', "zhougejing@11.com"));
